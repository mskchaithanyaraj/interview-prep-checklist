...
export const syllabus = {
  ...
  "6_DBMS": {
    Topics: [
      "ER Diagrams and Normalization (1NF to BCNF)",
      "Relational Model and Keys (Primary, Candidate, Foreign)",
      "SQL Queries (SELECT, JOINs, GROUP BY, HAVING, Subqueries, Window Functions)",
      "Transactions (ACID properties)",
      "Concurrency Control (Locking protocols, 2PL, Deadlocks)",
    ...
    InterviewFocus: [
      ...
      "Design schema for real-world systems",
      "Explain indexing and query optimization strategies",
    ],
  },
  "7_ImportantFormulasAndConcepts": {
    Topics: [
      "Catalan Numbers: Cₙ = (2n)! / ((n+1)! * n!)",
      "Number of BSTs with n nodes = Catalan number",
      ...
      "Pigeonhole Principle in hashing problems",
      "Bit Tricks: x & -x gives rightmost set bit",
      "Heap Insertion/Deletion time: O(log n)",
      "HashMap average-case lookup: O(1)",
      "Binary Search Template",
      "Graph Coloring for cycle detection in DAGs",
